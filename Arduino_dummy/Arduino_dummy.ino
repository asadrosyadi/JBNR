...
#define NODE_NAME "ESP32-DEV" // nama bluetooth
...
{
    static const double base_lat = -6.914744;   // dummy base coordinate
    static const double base_lon = 107.609810;  // (Bandung area, arbitrary)
