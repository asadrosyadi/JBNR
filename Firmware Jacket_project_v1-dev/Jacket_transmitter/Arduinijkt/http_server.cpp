...
// Global sensor values (plain globals, no locking - matches original firmware)
  ...
  <div class='thermo-wrapper'>
    <div class='thermo-container'>
      <div class='thermo-marks'>
        <div class='thermo-mark'>50&deg;C</div>
        <div class='thermo-mark'>40&deg;C</div>
        <div class='thermo-mark'>30&deg;C</div>
        <div class='thermo-mark'>20&deg;C</div>
        <div class='thermo-mark'>10&deg;C</div>
        <div class='thermo-mark'>0&deg;C</div>
      </div>
    ...
    <div class='thermo-value'>
      ...
      <span class='thermo-unit'>&deg;C</span>
    </div>
...
/* --------------------- HANDLERS --------------------- */
static void html_handler()
{
    server.send(200, "text/html", HTML_PAGE);
}

static void api_sensor_handler()
{
    char buffer[256];
...
void start_webserver(void)
{
    ...
    server.on("/", HTTP_GET, html_handler);
    server.on("/api/sensor", HTTP_GET, api_sensor_handler);
    server.begin();
}
