...
/*#define GPIO_NUM_MOSI 		6
#define GPIO_NUM_MISO 		5
#define GPIO_NUM_SCLK 		4
#define GPIO_NUM_CS    		7
#define GPIO_NUM_RST  		20 
#define GPIO_NUM_G0   		21*/
#define GPIO_NUM_MOSI 		6
#define GPIO_NUM_MISO 		5
#define GPIO_NUM_SCLK 		7
#define GPIO_NUM_CS    		10
#define GPIO_NUM_RST  		20 
